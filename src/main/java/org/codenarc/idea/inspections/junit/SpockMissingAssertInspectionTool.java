...
public class SpockMissingAssertInspectionTool extends CodeNarcInspectionTool<SpockMissingAssertRule> {
    ...
    // this code has been generated from org.codenarc.rule.junit.SpockMissingAssertRule

    public static final String GROUP = "Junit";

    public SpockMissingAssertInspectionTool() {
        super(new SpockMissingAssertRule());
