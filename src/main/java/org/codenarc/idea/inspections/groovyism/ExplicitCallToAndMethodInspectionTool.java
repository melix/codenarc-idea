...
public class ExplicitCallToAndMethodInspectionTool extends CodeNarcInspectionTool<ExplicitCallToAndMethodRule> {
    ...
    // this code has been generated from org.codenarc.rule.groovyism.ExplicitCallToAndMethodRule

    public static final String GROUP = "Groovyism";

    public ExplicitCallToAndMethodInspectionTool() {
        super(new ExplicitCallToAndMethodRule());
