...
public class MethodCountInspectionTool extends CodeNarcInspectionTool<MethodCountRule> {
    ...
    // this code has been generated from org.codenarc.rule.size.MethodCountRule
    ...
    public void setMaxMethods(int value) {
        getRule().setMaxMethods(value);
    }

    public int getMaxMethods() {
        return getRule().getMaxMethods();
    }
