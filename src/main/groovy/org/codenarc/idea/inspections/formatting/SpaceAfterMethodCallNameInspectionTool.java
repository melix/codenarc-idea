...
public class SpaceAfterMethodCallNameInspectionTool extends CodeNarcInspectionTool<SpaceAfterMethodCallNameRule> {
    ...
    // this code has been generated from org.codenarc.rule.formatting.SpaceAfterMethodCallNameRule

    public static final String GROUP = "Formatting";

    public SpaceAfterMethodCallNameInspectionTool() {
        super(new SpaceAfterMethodCallNameRule());
