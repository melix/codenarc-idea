...
public class ClosureStatementOnOpeningLineOfMultipleLineClosureInspectionTool extends CodeNarcInspectionTool<ClosureStatementOnOpeningLineOfMultipleLineClosureRule> {
    ...
    // this code has been generated from org.codenarc.rule.formatting.ClosureStatementOnOpeningLineOfMultipleLineClosureRule

    public static final String GROUP = "Formatting";

    public ClosureStatementOnOpeningLineOfMultipleLineClosureInspectionTool() {
        super(new ClosureStatementOnOpeningLineOfMultipleLineClosureRule());
    }
