...
public class UnnecessaryIntegerInstantiationInspectionTool extends CodeNarcInspectionTool<UnnecessaryIntegerInstantiationRule> {
    ...
    // this code has been generated from org.codenarc.rule.unnecessary.UnnecessaryIntegerInstantiationRule

    public static final String GROUP = "Unnecessary";

    public UnnecessaryIntegerInstantiationInspectionTool() {
        super(new UnnecessaryIntegerInstantiationRule());
