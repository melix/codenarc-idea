...
public class HighlightingDataExtractor {
  ...
  public HighlightingDataExtractor(@NotNull Document document,
  ...
  public HighlightingDataExtractor(@NotNull Document document, ResourceBundle... messageBundles) {
    myDocument = document;
  ...
  public String extractResult(@Nullable PsiFile psiFile, Collection<? extends HighlightInfo> infos, String text) {
  ...
  private String composeText(Collection<? extends HighlightInfo> infos, String text) {
    return composeText(myHighlightingTypes, infos, text, myMessageBundles);
  }
  ...
  private static boolean matchesPattern(@NotNull HighlightInfo expectedInfo, @NotNull HighlightInfo info) {
    ...
    boolean typeMatches = expectedInfo.type.equals(info.type) || (expectedInfo.type == WHATEVER || info.type == WHATEVER);
  ...
  private static boolean matchDescriptions(boolean strictMatch, String d1, String d2) {
    ...
    if (d1 != null && d2 != null) {
      ...
      return d2.endsWith(StringUtil.ELLIPSIS) && d2.regionMatches(0, d1, 0, d2.length() - 1);
    }
    return false;
  }
